...
const EndGame = ({ navigation }) => {
  ...
  const [winner, setWinner] = useState({ player: "", player1Info: { score: 0, tokens: 0 }, player2Info: { score: 0, tokens: 0 } });
      ...
      <Modal
        ...
        <View style={styles.centeredView}>
          <View style={[styles.modalView, { borderColor: color }]}>
            ...
            {winner.player == me ?
              <Text style={[styles.modalText, { color: color }]}>Victory</Text>
              :
              <>
                {winner.player == "Draw" ?
                  <Text style={[styles.modalText, { color: color }]}>Draw</Text>
                  :
                  <Text style={[styles.modalText, { color: color }]}>Defeat</Text>
                }
              </>
            }
